...
#
# {
# 	"script": "hello_world_advanced_using_netstacker_manager",
# 	"args": {
# 		"host": "10.0.2.33",
#         "username": "admin",
#         "password": "admin"
...
def run(**kwargs):
    try:
        ...
        log.info(f"hello_world_advanced_using_netstacker_manager: recieved {args}")
        ...
        log.info(f"hello_world_advanced_using_netstacker_manager: got back from task {return_result}")
        ...
        log.info(f"hello_world_advanced_using_netstacker_manager: triggering webhook with {webhook_meta}")
