...
# load models
from netstacker.backend.core.models.models import (
    TFSMTemplateRemove,
    TFSMTemplateAdd,
...
from netstacker.backend.core.models.transaction_log import TransactionLogEntryType

# load routes
from netstacker.backend.core.routes.routes import routes
...
from netstacker.routers.route_utils import HttpErrorHandler, add_transaction_log_entry
