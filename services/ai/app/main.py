...
from app.routes import agents, alerts, databus, incidents, knowledge, approvals, sessions, llm, chat, workflows
...
app.include_router(databus.router, prefix="/api/databus-sources", tags=["Databus Sources"])
...
async def root():
    return {
        ...
        "endpoints": [
            ...
            "/api/alerts/webhooks/prometheus",
            "/api/incidents",
            "/api/knowledge",
            "/api/approvals",
            "/api/sessions",
